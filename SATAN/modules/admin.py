...
from SATAN.modules.helper_funcs.admin_rights import (
    user_can_pin,
    user_can_promote,
    user_can_changeinfo,
)
...
def promote(update, context):
    ...
    message.reply_text("Yay ! Promoted Successfuly ! Now Give Party And Ur Pussy 🍻")
    return (
        "<b>{}:</b>"
        "\n#PROMOTED"
        "\n<b>Admin:</b> {}"
