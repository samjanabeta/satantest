...
from SATAN.modules.helper_funcs.extraction import extract_user_and_text
...
def ban(update, context):
    ...
    try:
        ...
        context.bot.sendMessage(
            chat.id,
            "{} Got Crushed By SATAN Hammer !".format(
                mention_html(member.user.id, member.user.first_name)
            ),
...
def kick(update, context):
    ...
    if is_user_ban_protected(chat, user_id):
        message.reply_text("Yeah. let's start kicking admins?")
        return ""
