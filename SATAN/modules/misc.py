...
from SATAN.__main__ import STATS, USER_INFO, GDPR
from SATAN.modules.disable import DisableAbleCommandHandler
from SATAN.modules.helper_funcs.extraction import extract_user
...
def info(update, context):
    ...
    del_msg = msg.reply_text(
        "Hold tight while I steal some data from <b>SATAN's Database</b>...😉😉",
...
def gdpr(update, context):
    ...
    update.effective_message.reply_text(
        ...
        "you from any chats, as that is telegram data, not SATAN Group Bot  data. "
...
def ud(update, context):
    ...
    if not text:
        ...
        msg.reply_text("Fuck off you bitch!")
        return
    elif text == "Pussy":
        msg.reply_text("Fuck off you bitch!")
        return
...
def src(update, context):
    update.effective_message.reply_text(
        "Hey there! You can find what makes me click [Here](t.me/SATANRockz) .",
        parse_mode=ParseMode.MARKDOWN,
        disable_web_page_preview=True,
    )
