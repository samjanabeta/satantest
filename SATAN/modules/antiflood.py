...
from SATAN.modules.helper_funcs.chat_status import is_user_admin, user_admin
from SATAN.modules.helper_funcs.string_handling import extract_time
from SATAN.modules.log_channel import loggable
from SATAN.modules.sql import antiflood_sql as sql
    ...
    if len(args) >= 1:
        ...
        if val == "off" or val == "no" or val == "0":
            ...
            if amount <= 0:
                ...
                send_message(
                    update.effective_message,
                    "Antiflood must be either 0 (disabled) or number greater than 5!",
                )
                return ""
...
def set_flood_mode(update, context):
    ...
    if args:
        if args[0].lower() == "ban":
            ...
            settypeflood = "mute"
            sql.set_flood_strength(chat_id, 5, "0")
