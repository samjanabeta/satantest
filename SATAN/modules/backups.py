...
import SATAN.modules.sql.notes_sql as sql
from SATAN import dispatcher, LOGGER, OWNER_ID, MESSAGE_DUMP
from SATAN.__main__ import DATA_IMPORT
from SATAN.modules.helper_funcs.chat_status import user_admin
from SATAN.modules.helper_funcs.alternate import typing_action

# from SATAN.modules.rules import get_rules
import SATAN.modules.sql.rules_sql as rulessql

# from SATAN.modules.sql import warns_sql as warnssql
import SATAN.modules.sql.blacklist_sql as blacklistsql
from SATAN.modules.sql import disable_sql as disabledsql

# from SATAN.modules.sql import cust_filters_sql as filtersql
# import SATAN.modules.sql.welcome_sql as welcsql
import SATAN.modules.sql.locks_sql as locksql
from SATAN.modules.connection import connected
...
def export_data(update, context):
    ...
    f = open("SATAN{}.backup".format(chat_id), "w")
    ...
    context.bot.sendDocument(
        current_chat_id,
        document=open("SATAN{}.backup".format(chat_id), "rb"),
        caption="*Successfully imported backup:*\nChat: `{}`\nChat ID: `{}`\nOn: `{}`\n\nNote: This `SATAN-Backup` is specially made for notes.".format(
            chat.title, chat_id, tgl
        ),
        timeout=360,
    ...
    os.remove("SATAN{}.backup".format(chat_id))  # Cleaning file
