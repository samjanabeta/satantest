...
if ENV:
    ...
    from SATAN.config import Development as Config
...
client = TelegramClient("IMPERIALELITEX", api_id, api_hash)
...
from SATAN.modules.helper_funcs.handlers import CustomCommandHandler
